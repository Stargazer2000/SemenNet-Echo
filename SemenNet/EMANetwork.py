...
from BiSeNet.resnet import resnet18,resnet50
...
class BiSeNet(nn.Module):
    ...
    def __init__(self, out_planes, is_training,
        ...
        # self.fc0=ConvBnRelu(2048, 512, 3, 1, 1,
        #                has_bn=True,
        #                has_relu=True, has_bias=False, norm_layer=norm_layer)
    ...
    def forward(self, data, label=None):
        ...
        # 使用resnet50,将维度从2048降到512
        # context_blocks[0]=self.fc0(context_blocks[0])
        ...
        # ffm spatial_out  和  context_out  前，需要对context_out进行维度调整
        concate_fm = self.ffm(spatial_out, context_out)
        concate_fm=self.shuffle(concate_fm)
        concate_fm=self.emau(concate_fm)
        print('concat_fm',concate_fm.shape)
