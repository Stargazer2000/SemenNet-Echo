...
from BiSeNet.HaloSelfAttn import ISA_Block
...
# from BiSeNet.newECAlayer2 import eca_layer
...
class BiSeNet(nn.Module):
    ...
    def __init__(self, out_planes, is_training,
        ...
        self.selfAttn=ISA_Block(out_channels=512,down_factor=[2,2])
        ...
        # self.eca_layer=eca_layer(channel=128,inp=128,oup=128,height=39,width=39)
