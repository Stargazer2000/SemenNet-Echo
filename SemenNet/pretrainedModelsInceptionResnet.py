...
class BiSeNet(nn.Module):
    ...
    def __init__(self, out_planes, is_training,
        ...
        #                              deep_stem=False, stem_width=64) num_classes
        self.context_path=timm.create_model('inception_resnet_v2',pretrained=True,num_classes=0,features_only=True,global_pool='')
        ...
        self.selfAttn=ISA_Block(in_channels=1536,out_channels=1536,down_factor=[2,2])
        ...
        self.global_context = nn.Sequential(
            ...
            ConvBnRelu(1536, conv_channel, 1, 1, 0,
                       has_bn=True,
        ...
        #Inception_resnet_v2=[1536,1088,320,192]
        arms = [AttentionRefinement(1536, conv_channel, norm_layer),
                AttentionRefinement(1088, conv_channel, norm_layer)]
