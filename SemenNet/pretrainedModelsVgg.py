...
class BiSeNet(nn.Module):
    ...
    def __init__(self, out_planes, is_training,
        ...
        self.context_path=timm.create_model('vgg16',pretrained=True,features_only=True,num_classes=0,global_pool='')
        ...
        self.selfAttn=ISA_Block(in_channels=512,out_channels=512,down_factor=[2,2])
